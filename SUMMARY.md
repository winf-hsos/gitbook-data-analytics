...
* [Daten](background/1-daten/README.md)
  * [Datensätze](background/1-daten/dimensions-of-data-sets.md)
  * [Dateneinträge](background/1-daten/dimensions-of-records.md)
  * [Datenattribute](background/1-daten/dimensions-of-fields.md)
  * [Skalen](background/1-daten/data-types-and-scales.md)
  * [Datentypen](background/1-daten/datentypen.md)
  * [Datenformate](background/1-daten/datenformate/README.md)
    * [Das CSV-Format](background/1-daten/datenformate/das-csv-format.md)
    * [Das JSON-Format](background/1-daten/datenformate/das-json-format.md)
    * [Das Parquet-Format](background/1-daten/datenformate/das-parquet-format.md)
* [Datenanalyse](background/datenanalyse/README.md)
  * [Ziel der Datenanalyse](background/datenanalyse/was-ist-datenanalyse.md)
  * [Schritte in der Datenanalyse](background/datenanalyse/steps-in-data-analytics.md)
  * [Typen von Fragen](background/datenanalyse/types-of-questions/README.md)
    * [Individuelle Datensätze finden](background/datenanalyse/types-of-questions/finding-individual-records.md)
    * [Daten zusammenfassen](background/datenanalyse/types-of-questions/summarizing-data.md)
    * [Daten erkunden](background/datenanalyse/types-of-questions/exploring-data.md)
    * [Schlüsse aus Daten ziehen](background/datenanalyse/types-of-questions/drawing-inferences-from-data.md)
    * [Fehlende Informationen vorhersagen](background/datenanalyse/types-of-questions/predicting-information.md)
    * [Kausalität feststellen](background/datenanalyse/types-of-questions/finding-causality.md)
  * [Explorative Datenanalyse](background/datenanalyse/explorative-datenanalyse.md)
* [Werkzeuge](background/3-werkzeuge/README.md)
  * [Überblick](background/3-werkzeuge/ueberblick.md)
  * [R und RStudio](background/3-werkzeuge/r-und-rstudio.md)
  * [Databricks](background/3-werkzeuge/databricks/README.md)
    * [Alles in einer Umgebung](background/3-werkzeuge/databricks/alles-in-einer-umgebung.md)
    * [Erste Schritte mit Databricks](background/3-werkzeuge/databricks/erste-schritte.md)
    * [Die Arbeit mit Notebooks](background/3-werkzeuge/databricks/die-arbeit-mit-notebooks/README.md)
      * [Dokumentation mit Markdown](background/3-werkzeuge/databricks/die-arbeit-mit-notebooks/dokumentation-mit-markdown.md)
      * [Schnelle Visualisierungen](background/3-werkzeuge/databricks/die-arbeit-mit-notebooks/built-in-visualizations.md)
      * [Daten importieren](background/3-werkzeuge/databricks/die-arbeit-mit-notebooks/import-data.md)
      * [Daten exportieren](background/3-werkzeuge/databricks/die-arbeit-mit-notebooks/export-data.md)
    * [Die Arbeit mit großen Datenmengen](background/3-werkzeuge/databricks/die-arbeit-mit-grossen-datenmengen.md)
    * [Strukturieren komplexer Analysen](background/3-werkzeuge/databricks/strukturieren-komplexer-analysen.md)
...
* [Working environment](einfuehrung-in-r/die-arbeitsumgebung.md)
